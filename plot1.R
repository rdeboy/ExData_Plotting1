...
#############################
## begin code for plot1.png

## Open a png device and create file in my working directory
png(file="plot1.png",  width = 480, height = 480, units = "px")

## Create plot and send to a file (no plot appears on screen)
with(energy.2day, hist(Global_active_power, main="Global Active Power", xlab="Global Active Power (kilowatts)", ylab="Frequency", col="red"))

## Close the png file device
dev.off()

## end code for plot1.png
#############################